...
const SavedArticles = () => {
        ...
        {articles.map((article, index) => (
          ...
          >
            ...
            <button
              ...
              className="w-full mt-4 text-indian-blue hover:text-blue-700 font-medium text-sm"
            >
              Read Article →
            </button>
          </div>
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
        <div className="flex items-center">
          ...
          <div>
            <h3 className="font-medium text-gray-900">FIR Application Form</h3>
            <p className="text-sm text-gray-600">Forms • 245 KB • 15 Jan 2024</p>
          </div>
        </div>
      ...
      <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
        <div className="flex items-center">
          ...
          <div>
            <h3 className="font-medium text-gray-900">Rental Agreement Template</h3>
            <p className="text-sm text-gray-600">Templates • 1.2 MB • 12 Jan 2024</p>
          </div>
        </div>
      ...
      <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
        <div className="flex items-center">
          ...
          <div>
            <h3 className="font-medium text-gray-900">Consumer Complaint Format</h3>
            <p className="text-sm text-gray-600">Forms • 180 KB • 10 Jan 2024</p>
          </div>
        </div>
  ...
  return (
    <div>
      ...
      {/* TABS + CONTENT */}
      <div className="bg-white rounded-xl shadow-lg mb-8 max-w-5xl mx-auto mt-10">
