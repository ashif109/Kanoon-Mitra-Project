...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Connect directly with specialized lawyers for your specific legal needs and court representation.",
      includes: [
        "Direct lawyer search & connection",
        "High Court & District court experts",
        "Video / Phone consultations",
        "Document review & case representation",
      ],
    ...
    {
      icon: (
        <div className="w-20 h-20 bg-gradient-to-r from-orange-500 to-amber-600 rounded-full flex items-center justify-center text-white mb-6 shadow-md">
          <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
          </svg>
        </div>
      ...
      description: "Complete assistance for filing Right to Information requests with proper Public Authority guidance.",
      includes: [
        "RTI application drafting",
        "Government department PIO mapping",
        "30-day response tracking",
        "First appeal guidance",
      ],
    ...
    },
    {
      ...
      description: "Help with filing cybercrime complaints, reporting digital fraud, and freezing stolen funds.",
      includes: [
        "Cybercrime complaint drafting",
        "Digital fraud & UPI reporting",
        "National 1930 Helpline guidance",
    ...
    },
    {
      ...
      description: "Download free legal document templates and formats for everyday legal procedures in India.",
      includes: [
        "Rent agreement & affidavit templates",
        "Legal notice formats & agreements",
        "Customizable DOCX & PDF files",
        "Guidance notes by advocates",
      ],
      cost: "Free",
